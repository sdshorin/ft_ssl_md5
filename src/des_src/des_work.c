...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/17 00:48:29 by sergey            #+#    #+#             */
/*   Updated: 2022/06/17 00:56:24 by sergey           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_params(t_des_flags *flags, t_des_env	*env)
{
	ft_putstr("salt: ");
	uint64_to_hex(*(uint64_t *)flags->salt);
	ft_putstr("key: ");
	uint64_to_hex(*(uint64_t *)env->key);
	ft_putstr("i_vector: ");
	uint64_to_hex(env->i_vector);
}
...
void	des_process_last_stream_block(t_des_env *env,
